...
tags: [kafka, streams, topic, tumbling, sliding, windowing, stateful, operations, api, best, practices, service, message-broker, design, tasarim, queue, mikroservis, microservice, blog, nasil-yapilir, mehmet-cem-yucel]
